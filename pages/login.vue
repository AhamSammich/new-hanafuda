          ...
          <div class="mt-10">
            <div class="flex-col space-y-8">
              <button
                ...
                type="button"
                @click="handleLoginAsGuest"
                class="w-full tracking-wide shadow-md sec-btn"
              >
                Continue as guest
              </button>
              ...
              >
                ...
                <div
                  :class="{ 'flex items-center justify-between': true, 'opacity-0 pointer-events-none': newAccount }"
                >
            ...
            <div class="mt-8">
              <div class="grid items-center grid-cols-[1fr_1fr_1fr] w-full">
                ...
                <div class="flex justify-center text-sm font-medium leading-6 w-max">
                  <span class="px-6 text-gray-900 dark:text-gray-300">{{
                    `or ${newAccount ? "sign up" : "sign in"} with`
                  }}</span>
                </div>
                <div aria-hidden="true">
                  <div class="w-full border-t border-gray-800 dark:border-gray-400/20" />
...
const handleEmailLogin = () => {
  loggingIn.value = true;
  emailAction(values.email, values.password).then((success) => {
    if (success) {
      if (userIsGuest.value) {
